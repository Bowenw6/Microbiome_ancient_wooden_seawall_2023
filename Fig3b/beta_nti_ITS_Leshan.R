...
Fasta_ITS<-read.table("otus_ITS.fa")
...
ASV_filtered_CK_fasta_ITS<-re_Fasta_ITS[match(row.names(ASV_filtered_CK), row.names(re_Fasta_ITS)),]
print(row.names(ASV_filtered_CK_fasta_ITS)==row.names(ASV_filtered_CK))
ASV_filtered_CK_fasta_ITS$ASVs_names<- gsub("ASV",">ASV",ASV_filtered_CK_fasta_ITS$ASVs_names)
write.table(ASV_filtered_CK_fasta_ITS, "ASV_filtered_CK_fasta_ITS.fasta",sep =",", row.names =FALSE, col.names =FALSE, quote =FALSE)
filtered_CK_fasta_ITS<-readLines("ASV_filtered_CK_fasta_ITS.fasta",encoding = "UTF-8")
filtered_CK_fasta_ITS<-gsub(",","\n",filtered_CK_fasta_ITS)
writeLines(filtered_CK_fasta_ITS,"filtered_CK_fasta_ITS.fasta")
rm(ASV_filtered_CK_fasta_ITS,filtered_CK_fasta_ITS)





ASV_filtered_Bla_fasta_ITS<-re_Fasta_ITS[match(row.names(ASV_filtered_Bla), row.names(re_Fasta_ITS)),]
print(row.names(ASV_filtered_Bla_fasta_ITS)==row.names(ASV_filtered_Bla))
ASV_filtered_Bla_fasta_ITS$ASVs_names<- gsub("ASV",">ASV",ASV_filtered_Bla_fasta_ITS$ASVs_names)
write.table(ASV_filtered_Bla_fasta_ITS, "ASV_filtered_Bla_fasta_ITS.fasta",sep =",", row.names =FALSE, col.names =FALSE, quote =FALSE)
filtered_Bla_fasta_ITS<-readLines("ASV_filtered_Bla_fasta_ITS.fasta",encoding = "UTF-8")
filtered_Bla_fasta_ITS<-gsub(",","\n",filtered_Bla_fasta_ITS)
writeLines(filtered_Bla_fasta_ITS,"filtered_Bla_fasta_ITS.fasta")
rm(ASV_filtered_Bla_fasta_ITS,filtered_Bla_fasta_ITS)
...
ASV_filtered_Gre_fasta_ITS<-re_Fasta_ITS[match(row.names(ASV_filtered_Gre), row.names(re_Fasta_ITS)),]
print(row.names(ASV_filtered_Gre_fasta_ITS)==row.names(ASV_filtered_Gre))
ASV_filtered_Gre_fasta_ITS$ASVs_names<- gsub("ASV",">ASV",ASV_filtered_Gre_fasta_ITS$ASVs_names)
write.table(ASV_filtered_Gre_fasta_ITS, "ASV_filtered_Gre_fasta_ITS.fasta",sep =",", row.names =FALSE, col.names =FALSE, quote =FALSE)
filtered_Gre_fasta_ITS<-readLines("ASV_filtered_Gre_fasta_ITS.fasta",encoding = "UTF-8")
filtered_Gre_fasta_ITS<-gsub(",","\n",filtered_Gre_fasta_ITS)
writeLines(filtered_Gre_fasta_ITS,"filtered_Gre_fasta_ITS.fasta")
rm(ASV_filtered_Gre_fasta_ITS,filtered_Gre_fasta_ITS)




ASV_filtered_Whi_fasta_ITS<-re_Fasta_ITS[match(row.names(ASV_filtered_Whi), row.names(re_Fasta_ITS)),]
print(row.names(ASV_filtered_Whi_fasta_ITS)==row.names(ASV_filtered_Whi))
ASV_filtered_Whi_fasta_ITS$ASVs_names<- gsub("ASV",">ASV",ASV_filtered_Whi_fasta_ITS$ASVs_names)
write.table(ASV_filtered_Whi_fasta_ITS, "ASV_filtered_Whi_fasta_ITS.fasta",sep =",", row.names =FALSE, col.names =FALSE, quote =FALSE)
filtered_Whi_fasta_ITS<-readLines("ASV_filtered_Whi_fasta_ITS.fasta",encoding = "UTF-8")
filtered_Whi_fasta_ITS<-gsub(",","\n",filtered_Whi_fasta_ITS)
writeLines(filtered_Whi_fasta_ITS,"filtered_Whi_fasta_ITS.fasta")
rm(ASV_filtered_Whi_fasta_ITS,filtered_Whi_fasta_ITS)



ASV_filtered_All_fasta_ITS<-re_Fasta_ITS[match(row.names(ASV_filtered_All), row.names(re_Fasta_ITS)),]
print(row.names(ASV_filtered_All_fasta_ITS)==row.names(ASV_filtered_All))
ASV_filtered_All_fasta_ITS$ASVs_names<- gsub("ASV",">ASV",ASV_filtered_All_fasta_ITS$ASVs_names)
write.table(ASV_filtered_All_fasta_ITS, "ASV_filtered_All_fasta_ITS.fasta",sep =",", row.names =FALSE, col.names =FALSE, quote =FALSE)
filtered_All_fasta_ITS<-readLines("ASV_filtered_All_fasta_ITS.fasta",encoding = "UTF-8")
filtered_All_fasta_ITS<-gsub(",","\n",filtered_All_fasta_ITS)
writeLines(filtered_All_fasta_ITS,"filtered_All_fasta_ITS.fasta")
rm(ASV_filtered_All_fasta_ITS,filtered_All_fasta_ITS)
...
#nohup muscle -align filtered_CK_fasta_ITS.fasta -output aligned_filtered_CK_fasta_ITS.fasta &
# in MacOS command line, construct tree with iqtree
#nohup iqtree -s aligned_filtered_CK_fasta_ITS.fasta -m MFP -B 1000 --bnni -cptime 6000 -T AUTO &

#in MacOS command line, perform alignment with muscle
#nohup muscle -align filtered_Bla_fasta_ITS.fasta -output aligned_filtered_Bla_fasta_ITS.fasta &
# in MacOS command line, construct tree with iqtree
#nohup iqtree -s aligned_filtered_Bla_fasta_ITS.fasta -m MFP -B 1000 --bnni -cptime 6000 -T AUTO &

#in MacOS command line, perform alignment with muscle
#nohup muscle -align filtered_Gre_fasta_ITS.fasta -output aligned_filtered_Gre_fasta_ITS.fasta &
# in MacOS command line, construct tree with iqtree
#nohup iqtree -s aligned_filtered_Gre_fasta_ITS.fasta -m MFP -B 1000 --bnni -cptime 6000 -T AUTO &

#in MacOS command line, perform alignment with muscle
#nohup muscle -align filtered_Whi_fasta_ITS.fasta -output aligned_filtered_Whi_fasta_ITS.fasta &
# in MacOS command line, construct tree with iqtree
#nohup iqtree -s aligned_filtered_Whi_fasta_ITS.fasta -m MFP -B 1000 --bnni -cptime 6000 -T AUTO &

#in MacOS command line, perform alignment with muscle
#nohup muscle -align filtered_All_fasta_ITS.fasta -output aligned_filtered_All_fasta_ITS.fasta &
# in MacOS command line, construct tree with iqtree
#nohup iqtree -s aligned_filtered_All_fasta_ITS.fasta -m MFP -B 1000 --bnni -cptime 6000 -T AUTO &




library(treeio)
tree_ITS_CK<-read.tree("aligned_filtered_CK_fasta_ITS.fasta.treefile")
tree_ITS_Bla<-read.tree("aligned_filtered_Bla_fasta_ITS.fasta.treefile")
tree_ITS_Gre<-read.tree("aligned_filtered_Gre_fasta_ITS.fasta.treefile")
tree_ITS_Whi<-read.tree("aligned_filtered_Whi_fasta_ITS.fasta.treefile")
tree_ITS_All<-read.tree("aligned_filtered_All_fasta_ITS.fasta.treefile")
...
paired_beta_nti_CK <- beta_nti(otu_niche = ASV_filtered_CK, otu_tree = tree_ITS_CK,1000,8)

write.table(paired_beta_nti_CK,"paired_beta_nti_CK.txt",quote = FALSE,
            sep = "\t",row.names = TRUE,col.names = TRUE)

paired_beta_nti_Bla <- beta_nti(otu_niche = ASV_filtered_Bla, otu_tree = tree_ITS_Bla,1000,8)

write.table(paired_beta_nti_Bla,"paired_beta_nti_Bla.txt",quote = FALSE,
            sep = "\t",row.names = TRUE,col.names = TRUE)

paired_beta_nti_Gre <- beta_nti(otu_niche = ASV_filtered_Gre, otu_tree = tree_ITS_Gre,1000,8)
write.table(paired_beta_nti_Gre,"paired_beta_nti_Gre.txt",quote = FALSE,
            sep = "\t",row.names = TRUE,col.names = TRUE)

paired_beta_nti_Whi <- beta_nti(otu_niche = ASV_filtered_Whi, otu_tree = tree_ITS_Whi,1000,8)
write.table(paired_beta_nti_Whi,"paired_beta_nti_Whi.txt",quote = FALSE,
            sep = "\t",row.names = TRUE,col.names = TRUE)

paired_beta_nti_All <- beta_nti(otu_niche = ASV_filtered_All, otu_tree = tree_ITS_All,1000,8)
