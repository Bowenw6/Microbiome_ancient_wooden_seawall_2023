...
picrust_16S_KO<-read.table("picrust2_out_pipeline_16S/KO_metagenome_out/pred_metagenome_unstrat.tsv",
...
ec_filter <- picrust_16S_KO[rowSums(picrust_16S_KO > 0) >= 0.1 * ncol(picrust_16S_KO), ]
...
ggsave(plot=p, filename ="KO_NMDS_plot.pdf", 
       width = 7, 
       height = 5,
       units = "in")
